"""
Tailwind CSS default color palette as Python constants.
You can import these in any Streamlit app or other modules.
Includes all default color families.
"""
...
# Core dictionary of all defined color families
COLORS = {
    "slate": slate,
    "gray": gray,
    "zinc": zinc,
